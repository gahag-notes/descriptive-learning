...
*** /Generalized Sequential Patterns/
    ...
    3. Para as sequências não unitárias, gera-se os candidatos da seguinte forma:
       #+attr_latex: :options [itemsep=0pt,label=\arabic*.]
       1. Sejam $s_1 = \left\langle \{i \mid x\} \mid s \mid y \right\rangle$ e
          $s_2 = \left\langle x \mid s \mid \{y \mid j\} \right\rangle$ sequências
          de ordem $k - 1$.

          Onde $s$ é uma sequência em comum, possivelmente vazia, e $x$ e $y$ são
          /itemsets/, possivelmente vazios. \\
